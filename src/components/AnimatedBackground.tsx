    const AnimatedBackground = () => {
        return (
            <div className="fixed inset-0 -z-10 overflow-hidden bg-linear-to-br from-slate-50 via-white to-blue-100">
                ...
                <svg className="absolute top-0 left-0 w-125 h-125 -ml-32 -mt-32 opacity-30 animate-blob-custom" viewBox="0 0 200 200">
                ...
                <svg className="absolute top-20 -right-25 w-96 h-96 opacity-20 animate-blob-custom animation-delay-2000" viewBox="0 0 200 200">
                ...
                <svg className="absolute -bottom-25 -left-12.5 w-150 h-100 opacity-25 animate-blob-custom animation-delay-4000" viewBox="0 0 200 100">
